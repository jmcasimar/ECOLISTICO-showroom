...
const pathPlantas = './img/PlantasP3/';
...
function animacionPlantas(startTime){
   ...
   */
   if (timeFromLastUpdatePlantas > timePerFramePlantas) {
       ...
       */
       $plantas.attr('src', pathPlantas + `PlantitasP3_${frameNumberPlantas}.png`);
...
$(document).ready(() => {
    for (var i = 1; i < framesPlantas + 1; i++) {
        $('body').append(`<div id="preload-image-${i}" style="background-image: url('${pathPlantas}PlantitasP3_${i}.png');"></div>`);
    }
