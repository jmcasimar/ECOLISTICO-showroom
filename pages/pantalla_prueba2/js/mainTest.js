...
// Animation velocity
const timePerFrameVentiladores = 83;
const timePerFramePlantas = 83;
const timePerFrameRiego = 83;
const timePerFrameLuces = 83;
const timePerFrameMedidores = 83;
const timePerFrameRectangulo = 83;
let timePerVentiladores = 83;
let timeFramePlantas = 83;
let timeFrameRiego = 83;
let timeFrameLuces = 83;
let timeFrameMedidores = 83;
let timeFrameRectangulo = 83;
...
function animacion(startTime) {
  ...
  if (timeFromLastUpdatePlantas > timePerFramePlantas) {
    ...
    if (frameNumberPlantas >= framesPlantas) {
      ...
      frameNumberPlantas = frameNumberPlantas + 2;
    } else {
      frameNumberPlantas = frameNumberPlantas + 2;
    }
  }
